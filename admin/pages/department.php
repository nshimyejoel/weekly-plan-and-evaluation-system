...
if(!$sql){
array_push($error,"department is not deleted");
}
else{
array_push($error,"department is  deleted succesfully");
}
}
?>
<html>
                ...
                <tr>
                 ...
                 $query= mysqli_query($con,"select * from department");
                  ...
                  <tr>
                      ...
                      <td><a href="editdepartment.php?depid=<?php echo $row["depid"];?>"><i class="fa fa-edit"></i>edit</a></td>
                      <td><a href="?depid=<?php echo $row["depid"];?>"><i class="fa fa-trash"></i>delete</a></td>
                  </tr>
                <?php
                  }
                  ?>
