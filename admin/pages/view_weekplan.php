...
if(isset($_GET["id1"]))
{
    $id=$_GET["id1"];
    $status=2;
    $sql="update plan set status='$status' where id='$id'";
    $query=mysqli_query($con,$sql);
    array_push($error,"successfully approved");
}
if(isset($_GET["id2"]))
{
    $id=$_GET["id2"];
    ...
    $sql="update plan set status='$status' where id='$id'";
    $query=mysqli_query($con,$sql);
    array_push($error,"successfully rejected");
}
?>
<html>
<head>
        ...
        <div class="row mb-2">
            ...
            ?>
                    <tbody>
                      <tr>
                        ...
                        <td><?php echo $row["expectedoutcomes"];?></td>
                          <td><label class="badge badge-success"><?php
                              if($row["status"]==1){
                                    echo "pending";
                                }
                    ...
                    echo"evaluation is made"; 
                          ...
                          <td><i class="fa fa-check"></i><a href="?id1=<?php echo $row["id"];?>">approve</a></td>
                          <td><i class="fa fa-times"></i><a href="?id2=<?php echo $row["id"];?>">reject</a></td>
                          <td><a href="?id=<?php echo $row["id"];?>"><i class="fa fa-trash"></i>delete</a></td>
                      </tr>
                    <?php } ?>
                      </tbody>
                    </table>
