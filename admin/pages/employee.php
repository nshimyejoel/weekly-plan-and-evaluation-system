...
if(!$sql){
array_push($error,"user is not deleted");
}
else{
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $row["telphonenumber"];?></td>
                  ...
                  <td><?php echo $row["registereddate"];?></td>
                    <td><a href="editemployee.php?id=<?php echo $row["id"];?>" class="btn btn-outline-success btn-sm"><i class="fa fa-edit"></i>edit</a></td>
                        <td><a href="?id=<?php echo $row["id"];?>" class="btn btn-outline-warning btn-sm"><i class="fa fa-trash-o">delete</i></a></td>
                </tr>
                <?php
                  }
                ?>
