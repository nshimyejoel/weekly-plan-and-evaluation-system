...
if(strlen($_POST["password"])<6 ){array_push($error,"password must contain 6 characters");}
     if(count ($error)== 0){
            $sql="update admin set fullname='$fname',email='$email',password='$password',status=$status where id='$id'";
...
<div class="col-sm-10">
<input type="email" name="email" class="form-control" id="rollid" value="<?php echo $row["email"];?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="password" name="password" class="form-control" id="rollid" value="<?php echo $row["password"]; ?>" required="required" autocomplete="off">
</div>
</div>
