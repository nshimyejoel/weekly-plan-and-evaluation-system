...
if(strlen($_POST["passwords"])<6 ){array_push($error,"password must contain 6 characters");}
     if(count ($error)== 0){
            $sql="update user set usernames='$username',passwords='$password',emails='$email',fullnames='$fullname',status=$status,depid='$department',chefdep='$head' where id='$id'";
    mysqli_query($con,$sql);
         if(!$sql){
             array_push($error,"unsuccessfull updated");
         }
         else{
             array_push($error,"successfull updated");
         }
}
}
?>
...
<div class="col-sm-10">
<input type="text" name="usernames" class="form-control" id="fullanme" value="<?php echo $row["usernames"]; ?>"  required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="password" name="passwords" class="form-control" id="rollid" value="<?php echo $row["passwords"];?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="email" name="emails" class="form-control" id="rollid" value="<?php echo $row["emails"]; ?>" required="required" autocomplete="off">
</div>
</div>
    
<div class="form-group">
<label for="default" class="col-sm-2 control-label">fullname</label>
<div class="col-sm-10">
<input type="text" name="fullnames" class="form-control" id="email" value="<?php echo $row["fullnames"]; ?>" required="required" autocomplete="off">
</div>
</div>
    <div class="form-group">
...
<option> <?php 
    ...
    <div class="form-group">
<label for="default" class="col-sm-2 control-label">head of department</label>
<div class="col-sm-10">
    <select name="head" required="required" autocomplete="off">
        <option >select the option</option>
        <option value="0" required="required">No</option>
        <option value="1"required="required">Yes</option>
    </select>
</div>
</div>
<div class="form-group">
