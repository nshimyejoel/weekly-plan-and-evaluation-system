...
if(isset($_POST["updates"]))
{
    ...
    $telnumber=$_POST["telphonenumber"];
    $email=$_POST["email"];
    $gender=$_POST["gender"];
...
$sql="update employee set fullname='$fullname',address='$address',telphonenumber='$telnumber',email='$email',gender='$gender',maritalstatus='$maritalstatus',dateofbirth='$dateofbirth',jobtitle='$jobtitle',department='$department' where id='$ids'";
    mysqli_query($con,$sql);
array_push($error,"data updated successfully");
}
?>
<html>
<head>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="user.php"><i class="fa fa-circle-o"></i> standard users</a></li>
              <li><a href="chef.php"><i class="fa fa-circle-o"></i> chef of departments</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
...
<div class="col-sm-10">
<input type="text" name="fullname" class="form-control" id="fullanme" value="<?php echo $row["fullname"]; ?>"  required="required" autocomplete="off">
...
<div class="col-sm-10">
<input type="text" name="address" class="form-control" id="rollid" value="<?php echo $row["address"];?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" name="telphonenumber" class="form-control" id="rollid" value="<?php echo $row["telphonenumber"]; ?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="maritalstatus" class="form-control" id="classname" value="<?php echo $row["maritalstatus"]; ?>" required="required" autocomplete="off" placeholder="married or not married">
</div>
</div>
<div class="form-group">
<label for="date" class="col-sm-2 control-label">Date Of Birth</label>
<div class="col-sm-10">
<input type="date"  name="dateofbirth" class="form-control" value="<?php echo $row["dateofbirth"]; ?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="jobtitle" class="form-control" id="job" value="<?php echo $row["jobtitle"]; ?>" required="required" autocomplete="off">
</div>
</div>
    <div class="form-group">
<label for="default" class="col-sm-2 control-label">Department</label>
<div class="col-sm-10">
<input type="text" name="department" class="form-control"  value="<?php echo $row["department"]; ?>" required="required" autocomplete="off">
</div>
</div>
<div class="form-group">
