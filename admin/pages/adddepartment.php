...
if(isset($_POST["add"]))
{
    ...
    $room=$_POST["room"];
    $reg=date("Y-m-d");
    $query="insert into department (name,room,regdate) values('$name',$room,'$reg')";
    mysqli_query($con,$query);
    if(!$query){
        array_push($error,"department is unsuccessfully added");
    }  
    else{
        array_push($error,"department is successfully added");
    }
}  
?>
<html>
...
<div class="col-sm-10">
<input type="name" name="name" class="form-control" id="fullanme" value=""  required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" name="room" class="form-control" id="rollid" value="" required="required" autocomplete="off">
</div>
</div>
<div class="form-group">
