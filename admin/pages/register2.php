...
if(strlen($_POST["passwords"])<6 ){array_push($error,"password must contain 6 characters");}
     if(count ($error)== 0){
            $query="insert into user (usernames,passwords,emails,fullnames,status,depid,chefdep) values('$username','$password','$email','$fullname','$status','$department','$head')";
...
<head>
  ...
  <title>Create standard user account</title>
...
<input type="text" name="usernames" class="form-control"  placeholder="abc"required="required" autocomplete="off">
</div>
<div class="form-group">
<label>password</label>	
<input type="password" name="passwords" class="form-control"  placeholder="******"required="required" autocomplete="off">
</div>
														
<div class="form-group">
<label>email</label>						
<input type="email" name="emails" class="form-control"  placeholder="abc@gmail.com"required="required" autocomplete="off">
</div>
    <div class="form-group">
        
        <div> <label>select department</label></div>
    ...
    <div class="form-group">
        <div><label>Head of department</label>	</div>					
        <select name="head">
...
<input type="text" name="fullnames" class="form-control"required="required" autocomplete="off" >
</div>
