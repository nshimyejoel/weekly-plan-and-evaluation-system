...
<div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h3>Manage Performance Report</h3>
                    ...
                    <table class="table center-aligned-table">
                      ...
                      <tbody>
                        ...
                        <tr class="">
                          ...
                          <td><a href="viewreport.php?id2=<?php echo $row["id"];?>" class="btn btn-primary btn-sm">View</a></td>
                          <td><a href="?id=<?php echo $row["id"];?>" class="btn btn-danger btn-sm">Remove</a></td>
                        </tr>
                        <?php }?>
                      </tbody>
                    </table>
