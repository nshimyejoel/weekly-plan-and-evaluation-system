...
{
    $id=$_GET["id"];
    $query=mysqli_query($con,"delete from weeklyreport where reportid='$id'");
    $query=mysqli_query($con,"delete from weekreport where reportid='$id'");
    array_push($error,"successfully deleted");
}
?>
<html>
<head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row mb-2">
            ...
            $select = mysqli_query($con,"SELECT reportid,user_id,depid,date FROM weeklyreport");
			...
			echo $rowuser["fullnames"]; ?>					
                      ...
                      <td><a href="view_weekreported.php?reportid=<?php echo $row['reportid']; ?>"><i class="fa fa-check-square-o"></i>  View</a></td>
                          <td><a href="?id=<?php echo $row["reportid"];?>"><i class="fa fa-trash"></i>delete</a></td>
                      </tr>
                    <?php } ?>
                      </tbody>
                    </table>
