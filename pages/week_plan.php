      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
            ...
            include '../connection.php';
             ...
             $select1= mysqli_query($con,"SELECT * FROM weeklyplan where depid='$dep'");	
 $row = mysqli_fetch_array($select1); 
$enddates=$row["enddate"];  
								
								$select = mysqli_query($con,"SELECT * FROM weeklyplan where  enddate > CURDATE() and depid='$dep'");
							...
							<tr>
								...
								<td>
                                    ...
                                    <a href="view_plan.php?planid=<?php echo $row['planid']; ?>"><i class="fa fa-check-square-o"></i>  VIEW</a>
