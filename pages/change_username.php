...
$query="select usernames from user where id='$id'";
$result=mysqli_query($con,$query);
$numrows=mysqli_num_rows($result);
    if($numrows>0){
$sql="update user set usernames='$username' where id='$id'";
...
$query=mysqli_query($con,"select usernames from user where id='$id'");
