      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
            ...
            include '../connection.php';
								...
								$id=$_SESSION["ids"];
								$select = mysqli_query($con,"SELECT * FROM weeklyreport where user_id='$id'");
                    ...
                    <tbody>
                      <tr>
                          ...
                          <td>
                            <a href="view_weekreported.php?reportid=<?php echo $row['reportid']; ?>"><i class="fa fa-check-square-o"></i>  VIEW</a>
								</td>
                      </tr>
                    <?php } ?>
                      </tbody>
