        ...
        <nav class="bg-white sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="weekreport.php">
                  <i class="fa fa-check-square-o"></i>
                <span class="menu-title">Week plan report</span>
              </a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="weekreported.php">
                  <i class="fa fa-folder-open"></i>
                <span class="menu-title">Week plan reported</span>
              </a>
            </li>
...
newTextBox4.setAttribute('name','outcomes[]');
       ...
       <p>week planning</p>
            <p><span class="style2">Add File</span>
              ...
              include'../connection.php';
				...
				$querypazzos=mysqli_query($con," select * from weeklyreport ");
				if(mysqli_num_rows($querypazzos))
				{
				$querytest=mysqli_query($con," select max(reportid) as lastreq from weeklyreport ");
				...
				$queryitem=mysqli_query($con," select * from weekreport where reportid='$lastrequi' ");
				...
				$query=mysqli_query($con," insert into weeklyreport values('','$ids','$department','$date')");
                    $querytest=mysqli_query($con," select max(reportid) as lastreq from weeklyreport ");
                    $recor=mysqli_fetch_array($querytest);
               ...
               <p><br/>Week plan report Number:<strong> No-000<?php echo $idadded; ?></strong><br/></p>
            ...
            <table  border="1" >
              <tr>
                ...
                <th width="240" scope="col"><span class="style1">Expected out comes</span></th>
                  <th width="240" scope="col"><span class="style1">Out comes</span></th>
              </tr>
              <tr>
                <td colspan="7">
                  <div id="MainDiv"> </div>
 ...
 $error=array();
    if(isset($_POST['Send'])){
								...
								while (list ($key,$val) = @each ($day) ) {
                                       ...
                                       list ($key,$val4) = @each ($outcomes);
									   mysqli_query($con,"INSERT INTO weekreport  VALUES ('','$val','$val2','$val3','$val4','$idreq')");
                                    array_push($error,"sent");
								}
    ...
    ?>
                        ...
                        <script>
											...
											alert("Weekly report successfully Added");
											window.location = ("weekreport.php")
