...
$usern=$_SESSION["name"];
$query="select usernames from user where usernames='$usern'";
$result=mysqli_query($con,$query);
$numrows=mysqli_num_rows($result);
    if($numrows>0){
$sql="update user set usernames='$username' where usernames='$usern'";
    mysqli_query($con,$sql);
array_push($error,"username is updated successfully");
}
else{
array_push($error,"username is not updated successfully");
}
}
?>
<html lang="en">
...
$query=mysqli_query($con,"select usernames from user where usernames='$username'");
while($row=mysqli_fetch_array($query)){
?>						
<form action="" method="post" >
<div class="form-group">
<label for="exampleInputEmail1">Current username</label>
<input type="text" name="usernames" class="form-control"  placeholder="Enter Current username" value="<?php echo $row["usernames"];?>">
</div>
